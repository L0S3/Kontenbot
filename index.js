...
/////////////////
const BotName = 'LOSE BOT☄'; 
const instagram = 'https://www.instagram.com/last_strik/'; 
const telegram = 'Gak punya:v'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = Gak punya:v';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@last_strik')
